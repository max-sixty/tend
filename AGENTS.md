...
**Tend's own instructions** are read only here: `AGENTS.md`, `TODO.md`,
...
| `AGENTS.md` | sessions working on the repo it sits in | no |
...
- **A rule has one home.** Another file that needs it names the section
  ...
  it across `plugins/`, `shared/`, and `AGENTS.md`.
