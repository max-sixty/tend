...
gh pr list --repo max-sixty/tend --state all --limit 200 --json number,title,state,mergedAt,body
gh issue list --repo max-sixty/tend --state all --limit 200 --json number,title,body
```
