...
#
# Every tracked file is assigned to one of 28 buckets via a deterministic
# hash of its path. Each day gets one bucket (unix day mod 28), so the
# full repo is surveyed every 28 days.
#
